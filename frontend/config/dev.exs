...
config :harden_llm, HardenLlmWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "lIMfgyGbZtoOqtZL3PsoEfoqIAYURaRZVLXr1VEZ7wERZrFN5SWmZCX+W0B8wmMY",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:harden_llm, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:harden_llm, ~w(--watch)]}
  ]
...
config :harden_llm, dev_routes: true
