defmodule HardenLlmWeb.FullWorkflowTest do
  ...
  defp run_full_workflow(session, width, height) do
    ...
    session =
      ...
      |> assert_has(Query.css("#profile-editor"))
      |> assert_has(Query.css("#profiles"))
      |> click(Query.css("#options-fold-toggle"))
      |> assert_has(Query.css("#profile-options"))
      |> click(Query.css("#retry-fold-toggle"))
      |> assert_has(Query.css("#profile-retry-repair"))
      |> click(Query.css("#pricing-fold-toggle"))
      |> assert_has(Query.css("#profile-pricing"))
      |> click(Query.css("#credential-fold-toggle"))
      |> click(Query.css("#credential-fold-toggle"))
      ...
      |> refute_has(Query.css("#profile-editor"))
    ...
    session =
      ...
      |> assert_has(Query.css("#workspace-reasoning[disabled]"))
      |> choose_option("#workspace-cache", "cache")
      |> assert_field_value("#run_selectedProfileId", "BrowserProfile")
