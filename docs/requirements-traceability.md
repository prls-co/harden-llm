...
| utility-llm frontend parity extension | `WorkspaceLive`, `ProfilesLive`, `HistoryLive`, `ProfileWidgetComponent`, `HardenAPI`, and `api/openapi.yaml` | WEB-TEST-031 through WEB-TEST-039; ADR-HLLM-012 |
